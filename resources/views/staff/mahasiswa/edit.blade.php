                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        {{ Form::open(array('route' => array('students.update', $mhsedit->id), 'method' => 'patch', 'files' => true)) }}
                            ...
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="prodi">Fakultas<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
                            ...
                            <div class="field item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" for="jurusan">Program Studi<span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6">
