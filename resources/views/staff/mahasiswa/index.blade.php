                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <div class="item form-group">
                            <label class="col-form-label col-md-3 col-sm-3 label-align" for="jurusan">Program Studi<span class="required">*</span>
                            </label>
                        ...
                        <div class="item form-group" style="margin-bottom: 10px; display:none;" id="showClass">
                            ...
                            <div class="col-md-6 col-sm-6 ">
                                <select class="form-control @error('kelas') is-invalid @enderror" name="kelas" id="kelas" required="required">
                                    @foreach ($kelas as $classes)
                                        <option value="{{ $classes->id }}">{{ $classes->nama_kelas }}</option>
                                    @endforeach
                                </select>
                                @error('kelas')
                                    <span class="badge badge-warning">{{ $message }}</span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="prodi"><b>Fakultas<span class="required">*</span></b></label>
                ...
                <div class="form-group">
                    <label for="jurusan"><b>Program Studi<span class="required">*</span></b></label>
