...
<html lang="en">
	...
	<body>
		<div class="limiter">
			<div class="container-login100" style="background-image: url('../assets/login/images/akademik.jpg');">
				<div class="wrap-login100 p-t-30 p-b-50">
					...
					@endif
					<form method="POST" action="{{ route('login') }}" class="login100-form validate-form p-b-25 p-t-2" autocomplete="off">
						{{ csrf_field() }}
